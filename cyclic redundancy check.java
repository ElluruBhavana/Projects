...
public class crc {
    ...
    public static void main(String args[]) {  
        ...
        Scanner scan = new Scanner(System.in)) {
            ...
            size = scan.nextInt();  
            // declaration of the divisor array  o
            int divisor[] = new int[size];  
            System.out.println("Enter divisor bits in the ar0ray one by one: ");  
            for(int i = 0 ; i < size ; i++) {  
                System.out.println("Enter bit " + (size-i) + ":");  
                divisor[i] = scan.nextInt();  
            }  
   // Divide the input data by th   e input divisor and store the result in the rem array  
